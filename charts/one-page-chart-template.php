...
class Disciple_Tools_Quick_Comments_Chart_Template extends DT_Metrics_Chart_Base
{
    public $base_slug = 'disciple-tools-quick-comments-metrics'; // lowercase
    public $base_title = "Quick Comments Plugin Metrics";
