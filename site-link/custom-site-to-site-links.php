...
class Disciple_Tools_Quick_Comments_Site_Links {
    public $type = 'disciple_tools_quick_comments';
    ...
    public function site_link_type( $type ) {
        $type[$this->type] = __( 'Quick Comments Plugin' );
        return $type;
    }
}
Disciple_Tools_Quick_Comments_Site_Links::instance();
